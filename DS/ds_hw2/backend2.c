...
void delete (char name[3])
{
  ...
  if (s_result == -1)
    ...
    for (s_result = s_result; s_result < k-1; s_result++) {
      data[s_result].name[0] = data[s_result+1].name[0];
      data[s_result].name[1] = data[s_result+1].name[1];
      data[s_result].name[2] = data[s_result+1].name[2];
      data[s_result].number[0] = data[s_result+1].number[0];
      data[s_result].number[1] = data[s_result+1].number[1];
      data[s_result].number[2] = data[s_result+1].number[2];
      data[s_result].number[3] = data[s_result+1].number[3];
    }
    k--;
